...
// Import the Character type to describe the shape of the character data
import { Character } from "@/types/star-wars";
import Image from "next/image";
import Link from "next/link";

// This component displays a card for a single character
// It receives one character as a prop
export default function CharacterCard({ character }: { character: Character }) {
    return (
        // Clicking the entire card navigates to the character detail page
        // The character id is used in the URL
